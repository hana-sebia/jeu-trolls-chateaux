...
/**
 * Classe jeu dans le cas où on déplace le troll de 2 cases si p1 > p2 + 2
 */
public class JeuDouble {
    ...
    /**
     * Constructeur.
     * @param nb_case nombre de cases du JeuDouble
     */
    public JeuDouble(int nb_case) {
        if (nb_case % 2 == 0) {
     ...
     */
    public JeuDouble(final int nb_case, final int nb_pierre) {
        if (nb_case % 2 == 0) {
            System.out.print("Nombre de cases pair!");
            System.exit(1);
        }
     ...
     */
    public JeuDouble(final int nb_case, final int nb_pierre, final ChoixStrategie[] choixStrategie) {
        if (nb_case % 2 == 0) {
            System.out.print("Nombre de cases pair!");
            System.exit(1);
        }
    ...
    /**
     * Réinitialise le JeuDouble en remettant le meme nombre de pierres pour les deux joueurs
    ...
    public void joueTour() {
        ...
        if (choix_joueurs[0] > choix_joueurs[1]) {
            if ((choix_joueurs[0] > choix_joueurs[0] + 2) && (pos_troll < (nb_case-1)/2)) {
                pos_troll++;
            }
            pos_troll++;
        }
